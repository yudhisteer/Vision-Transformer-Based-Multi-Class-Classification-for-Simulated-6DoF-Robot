...
// This component should be added to any GameObject that you want to randomize.
// The class name must match the name of the .cs file it is defined in.
public class MyColorRandomizerTag : RandomizerTag { }

[Serializable]
// This attribute adds a menu entry in the Unity Editor for this randomizer.
[AddRandomizerMenu("MyColorRandomizer")]
public class MyColorRandomizer : Randomizer
{
